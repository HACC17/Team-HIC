...
public final class SqlStatements {
  ...
  public static final String GET_ALL_DATA_FOR_LOCATION = "SELECT GRANT_TYPE, SUM(G.%s) FROM GRANTS G, GRANT_TYPES T, LOCATIONS L WHERE G.GRANT_TYPE_ID = T.ID AND G.LOCATION_ID = L.ID AND LOCATION = ? AND FISCAL_YEAR = ? GROUP BY GRANT_TYPE";
