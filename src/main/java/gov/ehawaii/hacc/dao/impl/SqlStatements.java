...
public final class SqlStatements {
  ...
  public static final String GET_TOTAL_FOR_EACH_LOCATION = "SELECT L.LOCATION, SUM(G.%s) FROM GRANTS G, LOCATIONS L WHERE G.LOCATION_ID = L.ID GROUP BY LOCATION_ID";

  public static final String GET_ALL_DATA_FOR_LOCATION = "SELECT ORGANIZATION, SUM(%s) FROM GRANTS G, ORGANIZATIONS O, LOCATIONS L WHERE G.ORGANIZATION_ID = O.ID AND G.LOCATION_ID = L.ID AND LOCATION = ? GROUP BY ORGANIZATION";
