		...
		<div class="container" id="body-container">
			...
			<div class="row nav-row">
				<c:if test="${not empty pageContext.request.userPrincipal}">
					...
					<div class="col-md-3">
						<a href="<c:url value='/reports' />" class="btn btn-lg btn-primary btn-block extra-top-margin" data-tab="reports">Reports</a>
					</div>
				</c:if>
			...
			<div class="row extra-top-margin">
				<div class="tab-pane" id="reports">
					<%@ include file="/WEB-INF/views/jspf/reports.jspf" %>
				</div>
			</div>
		</div>
